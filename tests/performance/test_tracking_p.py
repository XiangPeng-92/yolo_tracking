...
def test_motion_tracker_update_time(tracker_type):
    ...
    assert (
        elapsed_time_per_iteration < max_allowed_time
    ), f"Tracking algorithms processing time exceeds the allowed limit:  {elapsed_time_per_iteration} > {max_allowed_time}"
